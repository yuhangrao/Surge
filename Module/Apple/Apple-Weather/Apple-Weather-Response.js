...
commit: 8cf7d2458d82b1355d6acf1553ef774d3e8339f1
*/
...
const database = {
  ...
  Weather: {
    Settings: {
      ...
      APIs: {
        ...
        WAQI: { HTTPHeaders: { 'Content-Type': 'application/json' }, Token: '850a455c30d2305fa907efbbfb15bea99a3fa164', Mode: 'Station' },
      },
    },
    Configs: {
      Pollutants: {
  ...
  Siri: {
    Settings: {
      Switch: true, CountryCode: 'US', Domains: ['web', 'itunes', 'app_store', 'movies', 'restaurants', 'maps'], Functions: ['flightutilities', 'lookup', 'mail', 'messages', 'news', 'safari', 'siri', 'spotlight', 'visualintelligence'], Safari_Smart_History: true,
    },
  },
};
